                ...
                while (true) {
                    ...
                    if (tomtomMap.userLocation != null) {
                        ...
                        val routeCalculationDescriptor = RouteCalculationDescriptor.Builder()
                            ...
                            .build()
                        val routingApi = OnlineRoutingApi.create(requireContext(), "AwDIXPNqAIMFsVtO3elZXNHQUfEi4qGG")
                        val spec = RouteSpecification.Builder(LatLng(tomtomMap.userLocation!!.latitude,
                                                                    tomtomMap.userLocation!!.longitude), location)
                        ...
                        val route = routingApi.planRoute(spec, object : RouteCallback{
                            ...
                            override fun onSuccess(routePlan: RoutePlan) {
                                val routeBuilder = RouteBuilder(routePlan.routes.first().getCoordinates())
