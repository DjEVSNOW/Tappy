...
class HomeViewModel(private val apiRepository: ApiRepository) : BaseViewModel(apiRepository) {
    ...
    val destinations = listOf(
        Destination(0,
            ...
            100000,15, TransferType.PLANE, listOf("Детям","Пляж","Развлечения")),
        Destination(1,
            "Новгород",
            "https://www.advantour.com/russia/images/veliky-novgorod/veliky-novgorod.jpg",
            1000,3, TransferType.CAR, listOf("История","На выходные","Для всех")),
        Destination(2,
            "Новгород",
            "https://www.advantour.com/russia/images/veliky-novgorod/veliky-novgorod.jpg",
            1000,5, TransferType.BUS, listOf("Эко","Активный","Для взрослых")),
        Destination(3,
            "Казань",
            "https://flysmartavia.com/media/images/city/20200707_kaz.jpg",
            30000,13, TransferType.PLANE, listOf("Гастрономичсекий","Длинный","Для всех")),
        Destination(4,
            "Калининград",
            "https://visit-kaliningrad.ru/upload/0_1003fe_91733604_orig.jpg",
            50000,7, TransferType.PLANE, listOf("История")),
